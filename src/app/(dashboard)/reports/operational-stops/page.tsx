...
export default function OperationalStopsReport() {
  ...
  const handleDownloadCSV = () => {
    ...
    downloadCSV(csvData, "paros-por-operacion");
  };
      ...
      <div className="space-y-6">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-4">
            ...
            <h1 className="text-2xl font-semibold">Reporte de Paros por Operación</h1>
          </div>
