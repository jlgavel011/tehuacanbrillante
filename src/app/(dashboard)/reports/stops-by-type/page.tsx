...
export default function StopsByTypePage() {
  ...
  useEffect(() => {
    const fetchData = async () => {
      ...
      try {
        ...
        const response = await fetch(`/api/analytics/stops-by-type?${params}`);
    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-4">
          ...
          <h1 className="text-2xl font-semibold">Reporte de Paros por Tipo</h1>
        </div>
        <DateRangeFilter
          date={date}
            ...
            <>
              <div className="flex items-center justify-between gap-4">
                <div className="flex-1">
                  <Input
                    placeholder="Buscar por tipo de paro..."
                    value={searchTerm}
              ...
              {loading ? (
                ...
                <div className="rounded-md border">
                  <Table>
                    <TableHeader>
                      <TableRow>
                        <TableHead>Tipo de Paro</TableHead>
