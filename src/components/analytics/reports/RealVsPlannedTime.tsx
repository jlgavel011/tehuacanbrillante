...
export default function RealVsPlannedTime() {
  ...
  const handleViewDetails = () => {
    router.push(`/reports/real-vs-planned-time-detail`);
  };
  ...
  return (
    <ReportCard
      title="Tiempo Real vs Planificado de Producción"
      subtitle="Comparación de tiempos de producción real vs planificado por número de orden"
      headerExtra={
        <Button
          variant="ghost"
          size="icon"
