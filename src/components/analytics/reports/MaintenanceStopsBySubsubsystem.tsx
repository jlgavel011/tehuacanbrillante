...
export function MaintenanceStopsBySubsubsystem() {
  ...
  if (loading) {
    return (
      <ReportCard
        title="Subsubsistemas con Más Paros por Mantenimiento"
        subtitle="Top 5 subsubsistemas con más paros"
      >
  ...
  // Tomar los top 5 subsubsistemas para el gráfico
  ...
  const handleViewDetails = () => {
    router.push("/reports/maintenance-stops-by-subsubsystem");
  };
