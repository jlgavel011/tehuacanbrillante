...
export function OperationalStopsBySystem() {
  ...
  if (loading) {
    return (
      <ReportCard
        title="Sistemas con Más Paros por Operación"
        subtitle="Distribución de paros por sistema"
      >
  ...
  const handleViewDetails = () => {
    router.push("/reports/operational-stops-by-system");
  };
